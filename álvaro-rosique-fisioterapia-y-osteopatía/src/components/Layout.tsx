      ...
      <Container>
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 md:mb-16 gap-6">
          <div className="max-w-2xl">
            <div className="flex items-center space-x-3 text-blue-600 font-black uppercase tracking-luxury text-[10px] mb-4">
              <HelpCircle size={16} />
          ...
          <Link 
            ...
            className="group flex items-center space-x-3 text-[11px] font-black uppercase tracking-luxury text-brand-950 hover:text-blue-600 transition-colors"
          >
        ...
        <Container>
          <div className="flex justify-between items-center h-20 lg:h-28">
            ...
            <div className="hidden lg:flex items-center space-x-6">
              ...
              <Link
                to="/contacto"
                className="px-6 py-3.5 bg-brand-950 text-white rounded-full text-[12px] font-bold uppercase tracking-luxury hover:bg-blue-800 transition-all"
              >
                Cita
              </Link>
            </div>
        ...
        <div className="flex flex-col h-full pt-32 pb-12 px-8">
          <nav className="flex flex-col space-y-8 flex-grow">
            {navLinks.map((link) => (
              ...
              >
                {link.name}
                {location.pathname === link.path && <ChevronRight className="text-blue-500" size={32} />}
              </Link>
            ))}
          </nav>
        ...
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-12 md:gap-24 mb-16 md:mb-24">
            <div>
              ...
              <div className="flex space-x-8 text-[9px] md:text-[10px] font-extrabold uppercase tracking-luxury">
                {SITE_DATA.socials.map((s) => (
                  <a key={s.platform} href={s.url} className="text-blue-400 hover:text-white transition-colors">
                    {s.platform}
                  </a>
                ))}
              </div>
            ...
            <div className="xl:pl-16">
              <h4 className="text-[9px] md:text-[10px] font-extrabold uppercase tracking-luxury text-blue-400 mb-8">Navegación</h4>
            ...
            <div>
              <h4 className="text-[9px] md:text-[10px] font-extrabold uppercase tracking-luxury text-blue-400 mb-8">El Centro</h4>
              <ul className="space-y-6 md:space-y-8 text-sm">
                <li className="flex items-start space-x-4 md:space-x-6">
                  <MapPin className="text-blue-400 shrink-0 w-4 h-4 md:w-[18px] md:h-[18px]" />
                ...
                <li className="flex items-center space-x-4 md:space-x-6">
                  <Phone className="text-blue-400 shrink-0 w-4 h-4 md:w-[18px] md:h-[18px]" />
                  <a href={`tel:${SITE_DATA.contact.phone}`} className="text-white font-bold text-sm md:text-base tracking-widest hover:text-blue-400 transition-colors">{SITE_DATA.contact.phone}</a>
                </li>
              </ul>
            </div>

            <div>
              <h4 className="text-[9px] md:text-[10px] font-extrabold uppercase tracking-luxury text-blue-400 mb-8">Horarios</h4>
