    ...
    <>
        ...
        <Container>
          <div className="grid lg:grid-cols-2 gap-20 md:gap-32 lg:gap-40 items-center">
            <div className="relative z-10 animate-in fade-in slide-in-from-left duration-1000">
              ...
              <H1 className="mb-8 md:mb-12 tracking-tighter leading-tight lg:leading-[1.1]">Pasión por <span className="text-blue-600 italic">cuidarte</span>.</H1>
              <div className="space-y-6 md:space-y-8 mb-12 md:mb-16">
                <Text className="text-xl md:text-2xl lg:text-3xl leading-snug text-brand-950 font-medium tracking-tight">
                  Soy <span className="font-bold text-blue-600">Álvaro Rosique</span>, y mi objetivo es que te sientas bien en tu propio cuerpo.
                </Text>
                <Text className="text-lg md:text-xl text-slate-500 leading-relaxed avenir-minimal">
              ...
              <div className="flex flex-wrap gap-8 relative z-30">
                <Button href={SITE_DATA.contact.whatsapp} variant="primary" className="h-20 md:h-28 min-w-[240px] shadow-2xl hover:scale-105 transition-transform">
                  Agendar Consulta
                </Button>
                <Button href="#pilares" variant="outline" className="h-20 md:h-28 min-w-[240px] border-brand-950/10 text-brand-950 hover:bg-brand-50">
                  Nuestra Filosofía
                </Button>
              </div>
            </div>
            <div className="relative animate-in fade-in slide-in-from-right duration-1000">
              ...
              <div className="absolute -bottom-10 -left-10 md:-bottom-20 md:-left-20 bg-brand-950 text-white p-10 md:p-16 rounded-[2.5rem] md:rounded-[4rem] shadow-3xl hidden md:block z-20 border border-white/5">
                <div className="text-5xl md:text-8xl font-black mb-3 tracking-tighter text-blue-400">+15</div>
          ...
          <Grid cols={3}>
            {[
              ...
              <Card key={i} className="group hover:-translate-y-2 transition-all duration-700 hover:shadow-2xl bg-white border-none shadow-sm">
                <div className="w-16 h-16 bg-blue-600/10 rounded-2xl flex items-center justify-center text-blue-600 mb-8 mx-auto md:mx-0 group-hover:bg-blue-600 group-hover:text-white transition-colors duration-500">
                  <v.icon size={32} />
                </div>
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16 md:mb-32">
              ...
              <h2 className="text-4xl md:text-7xl font-bold mb-8 md:mb-12 tracking-tighter">Mi formación y experiencia.</h2>
              <p className="text-slate-400 text-lg md:text-2xl font-light avenir-minimal">Siempre estoy aprendiendo nuevas formas de cuidar a mis pacientes en Cartagena. Aquí tienes un resumen de mi trayectoria.</p>
            </div>
            ...
            <div className="space-y-16 md:space-y-24 relative before:absolute before:left-0 md:before:left-1/2 before:top-0 before:bottom-0 before:w-[1px] before:bg-white/10 before:-translate-x-1/2 hidden md:block">
              {[
                ...
                <div key={i} className={`flex flex-col md:flex-row items-center justify-between w-full mb-8 relative ${c.align === 'left' ? 'md:flex-row-reverse' : ''}`}>
                  ...
                  <div className="absolute left-0 md:left-1/2 w-4 h-4 bg-blue-500 rounded-full border-4 border-brand-950 -translate-x-1/2 z-10 shadow-[0_0_20px_rgba(59,130,246,0.5)]"></div>
                  <div className={`w-full md:w-5/12 ${c.align === 'left' ? 'md:text-right' : 'md:text-left'}`}>
                    <div className="text-blue-400 font-black text-2xl mb-2 tracking-tighter">{c.year}</div>
            ...
            <div className="space-y-12 md:hidden">
              {[
                ...
                <div key={i} className="border-l-2 border-blue-500 pl-6 pb-4">
                  <div className="text-blue-400 font-black text-xl mb-1">{item.year}</div>
      ...
      <Section className="bg-brand-50 py-20 md:py-32 border-t border-brand-100">
        <Container className="text-center">
          <div className="max-w-4xl mx-auto">
            <GraduationCap className="mx-auto text-blue-600 mb-8 w-12 h-12 md:w-20 md:h-20" />
            <h2 className="text-4xl md:text-7xl font-bold mb-8 md:mb-12 tracking-tighter leading-[1.1] text-brand-950">
              ¿Quieres volver a moverte <span className="text-blue-600">sin dolor</span>?
            </h2>
...
const QuoteIcon = ({ className = "" }) => (
  <svg width="40" height="30" viewBox="0 0 40 30" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M11.6667 0C5.22667 0 0 5.22667 0 11.6667V28.3333H15V13.3333H6.66667C6.66667 8.91333 10.2467 5.33333 14.6667 5.33333L11.6667 0ZM36.6667 0C30.2267 0 25 5.22667 25 11.6667V28.3333H40V13.3333H31.6667C31.6667 8.91333 35.2467 5.33333 39.6667 5.33333L36.6667 0Z" fill="#3B82F6" fillOpacity="0.2"/>
  </svg>
);
